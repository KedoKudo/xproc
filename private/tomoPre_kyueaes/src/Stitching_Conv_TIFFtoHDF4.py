...
def prefInitMatlab():
    ...
    prefs["vis"]["projection"]["imgRange"] = prefListToArrayD(
        prefs["vis"]["projection"]["imgRange"]
    )
    prefs["vis"]["beamProfileInitial"]["imgRange"] = prefListToArrayD(
        prefs["vis"]["beamProfileInitial"]["imgRange"]
    )
    prefs["vis"]["beamProfileFinal"]["imgRange"] = prefListToArrayD(
        prefs["vis"]["beamProfileFinal"]["imgRange"]
    )
    prefs["vis"]["dark"]["imgRange"] = prefListToArrayD(
        prefs["vis"]["dark"]["imgRange"]
    )
    prefs["vis"]["stitching"]["ColorCodeLim"] = prefListToArrayD(
        prefs["vis"]["stitching"]["ColorCodeLim"]
    )
    ...
    prefs["slitposcheck"]["projection"]["Num"] = prefListToListArrayD(
    ...
    prefs["beamProfileInitial"]["Num"] = prefListToListArrayI(
        prefs["beamProfileInitial"]["Num"]
    )
    prefs["beamProfileFinal"]["Num"] = prefListToListArrayI(
    ...
    prefs["beamProfileInitial"]["extension"] = str(
        prefs["beamProfileInitial"]["extension"]
    )
...
def dataPrepare(prefs):
    ...
    prefs, nOut, monitor, moncnt, dataWhite1 = avgTransform.avgTransform(
        prefs, nOut, "WHITE1", "beamProfileInitial", fileID, moncnt
    )

    nOutst = nOut

    prefs, nOut, monitor, moncnt, dataProj = projTransform.projTransform(
        prefs, nOutst, "PROJ", "projection", fileID, moncnt
    )

    prefs, nOut, monitor, moncnt, dataWhite2 = avgTransform.avgTransform(
        prefs, nOut, "WHITE2", "beamProfileFinal", fileID, moncnt
    )

    prefs, nOut, monitor, moncnt, dataDark = avgTransform.avgTransform(
        prefs, nOut, "DARK", "dark", fileID, moncnt
    )

...
def initPyPref(prefs):
    ...
    prefs["out"][
        "filePath"
    ] = "/home/beams12/S1IDUSER/mnt/orthros/Faber_Feb14_rec/Disc2_LLZO_SGF_D255/raw"
    prefs["out"]["filePrefix"] = "mp90s0.2_tomo"
    prefs["out"]["numberDigit"] = 5
    prefs["out"]["fileType"] = "uint16"
    prefs["out"]["VertSizeWarningAt"] = 128
    ...
    prefs["slits"]["tlx"] = 11 + 50 + 40
    prefs["slits"]["tly"] = 10
    prefs["slits"]["brx"] = 2039 - 50 - 40
    prefs["slits"]["bry"] = 1270
    prefs["slits"]["ROISizex"] = 20 + 100
    prefs["slits"]["ROISizey"] = 300
    ...
    prefs["slits"]["tempFrameSizex"] = 7
    prefs["slits"]["tempFrameSizey"] = 60
    ...
    prefs["slitposcheck"]["projection"]["Num"].append(
        prefs["projection"]["Num"][0][0:1800:50]
    )
    prefs["slitposcheck"]["projection"]["Num"].append(
        prefs["projection"]["Num"][1][0:1800:50]
    )
    prefs["slitposcheck"]["projection"]["Num"].append(
        prefs["projection"]["Num"][2][0:1800:50]
    )
    prefs["slitposcheck"]["projection"]["Num"].append(
        prefs["projection"]["Num"][3][0:1800:50]
    )

    prefs["slits"]["usePrevious"] = True

    prefs["template"] = [
        array("d", [2545, 3172, 15, 50]),
        array("d", [2545, 3450, 15, 50]),
        array("d", [2545, 3850, 15, 50]),
        array("d", [2545, 4100, 15, 50]),
    ]
    prefs["searchrange"] = [
        array("d", [25, 100]),
        array("d", [25, 100]),
